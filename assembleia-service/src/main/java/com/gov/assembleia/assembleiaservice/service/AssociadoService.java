...
public class AssociadoService {
  ...
  public AssociadoDTO salvar(AssociadoDTO dto){
    ...
    SessaoVotacaoDTO sessaoVotacaoDTO = sessaoVotacaoService.buscarSessaoPorId(dto.getIdSessaoVotacao());
    if(sessaoVotacaoDTO.getHorarioTermino().isBefore(LocalDateTime.now())){
